...
{
	std::cout << BLUE << "[DEBUG]" << RESET << std::endl << "I love to get extra bacon for my 7X"
...
{
	std::cout << GREEN << "[INFO]" << RESET << std::endl << "I cannot believe adding extra bacon "
...
{
	std::cout << YELLOW << "[WARNING]" << RESET << std::endl << "I think I deserve to have some ex"
...
{
	std::cout << RED << "[ERROR]" << RESET << std::endl << "This is unacceptable, I want to spe"
